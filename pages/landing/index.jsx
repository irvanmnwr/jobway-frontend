...
export default function Landing() {
  ...
  const handleStart = () => {
    if (dataCookies) {
      ...
      router.push("/auth/option/register");
    }
  };
  return (
    <div className="landing">
          ...
          <div className="container">
            ...
            >
              ...
              <Link href="../auth/option/register">
                <button
                  className="landing-nav-btn-purple btn btn-primary"
                  href="../signIn"
                >
                  Daftar
                </button>
      ...
      <div className="header">
        <div className="content-main container">
          <div className="content-left pe-5">
            ...
            <button
              className="landing-purple-btn btn btn-primary"
              onClick={handleStart}
            >
              Mulai Dari Sekarang
            </button>
            ...
            <div className="d-flex">
              <div className="me-5">
                <div className="sub-list-1">
                  <img
                    src="../../images/landing/orange-check-icon.png"
                    alt="orange-check-icon"
                  />
                  <p>Java</p>
                </div>
                <div className="sub-list-1 mt-4">
      ...
      <div className="call-action">
        <div className="call-action-content container">
          ...
          <button
            className="landing-white-btn btn btn-primary"
            onClick={handleStart}
          >
            Mulai Dari Sekarang
          </button>
