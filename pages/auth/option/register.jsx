        ...
        <div className="option-content">
          ...
          <div className="option-btn">
            <Link href="../pekerja/register">
              <button className="option-nav-btn-white btn btn-primary me-3">Daftar sebagai pekerja</button>
            </Link>
            ...
            <Link href="../perekrut/register">
              <button className="option-nav-btn-line btn btn-primary me-3">Daftar sebagai perekrut</button>
            </Link>
          </div>
        </div>
      </div>
